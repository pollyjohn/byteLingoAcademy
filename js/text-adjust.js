document.addEventListener("scroll", function() {
    ...
    const button = document.querySelector('#btnExplorar');
    ...
    if (window.scrollY > buttonOffsetTop *3) {
        ...
        document.querySelector(".logo img").classList.add("sumido");
    } else {
        // quando o usuário não está scrollando para baixo, remove a classe "sumido" da logo
        document.querySelector(".logo img").classList.remove("sumido");
    }
      });